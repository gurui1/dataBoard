    ...
    <div>
        ...
        <div class="container container-bird">
            ...
            <div class="container-title">
                ...
                <div class="subtitle">请登录业务结算平台或联系管理员处理！</div>
                <div class="btn">
                    <button @click="goHome" style="margin-right: 0px">返回首页</button>
...
function goBack() {
    // 获取前一页路由信息
    const previousRoute = router.getRoutes().slice(-2)[0];
    console.log(previousRoute);
    

    // 判断前一页路由是否包含 '/databoard'，如果是则跳转到百度首页，否则执行返回上一页操作
    if (previousRoute.path.includes('/databoard')) {
